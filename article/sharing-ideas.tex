...
その知見に構造を与え，情報を共有することはは必ずしも簡単ではない．
...
情報に構造を与え，学習者が未知の情報を想像しやすくするような工夫も試みに含まれる．
これらの試みは iTunes U, Khan Academy, MIT Video などのホスティングサービス上で提供される
コースの多数で試みらている．\cite{nu,mh}
...
また，講演は以下の構造のいずれかに従うようにコーチングを行っている．
\begin{description}
\item[Chronological] 時系列によって情報を紹介する．
\item[Cause and Effect (Problem and Solution)] まず結果（問題）を示し，次に原因（解法）を示す．
\item[Contrast and Similarity] 情報Aと情報Bとを比較して，その違いまたは類似性を紹介する．
\item[Classification and Definition] 情報を部分に分割する方法とその結果を紹介する．
\end{description}
これらは，英語圏で一般に rhetorical modes と言われるライティングスタイル \cite{cs} のうち，
特に \TEDx 講演に適したものを選択したものである．
特にサイエンス，テクノロジーに関する発表に関しては Cause and Effect (Problem and Solution) スタイルを
採用することが多い．
...
上述のルールを遵守することで，\TEDxKyoto の講演は品質を保っており，高い評価を得ている．\cite{ml}
...
\section{情報アーキテクチャとエンタテイメント}

厳密に情報アーキテクチャを講演に埋め込んだ \TED および \TEDxKyoto の
取り組みはアイディア共有の手段として，またエンタテイメントとして高く評価されている．
一方で，意図的に情報アーキテクチャを廃したカンファレンスがワーマンによって2012年に提案されている．
このカンファレンスについて次に述べる．

\subsection{WWWカンファレンスと555カンファレンス}

% ワーマンは1998年に医療系に特化した \TED カンファレンスである \TEDMED カンファレンスを設立し，
% \TED ルールに縛られないが \TED と趣旨の近いカンファレンスEGを2006年に設立している．
ワーマンは2012年にWWWカンファレンスを主催するにあたって，参加者に次のように呼びかけている．\cite{wwwweb}
...
WWW/555カンファレンスのような，意図的な情報アーキテクチャの排除がアイディア共有の手段として
優れているかどうかは未知であり，またそれが持続可能な取り組みかどうかも本稿執筆時点では未知である．

\subsection{情報アーキテクチャの必要性}

アイディア共有のための手段としての情報アーキテクチャの組込みは，\TED, \TEDxKyoto を通して
高い評価を受けており，またその持続可能性を示しつつある．

前節のWWW/555カンファレンスの取り組みは情報アーキテクチャを排除するものであるが，
両手段は排他的ではなく，またWWW/555カンファレンスの成功が情報アーキテクチャの必要性を必ずしも否定するものはない．
...
講演にエンタテイメントとしての性質をもたせ，それによってアイディア共有を効果的に行うことを試みており，
その試みは世界的に評価されつつある．
...
\bibitem{historyofted} TED: \textit{History of TED (online);} \urle{https://www.ted.com/about/our-organization/history-of-ted} (2014-07-21).
...
\bibitem{cgweb} Camine Gallo: \textit{The Science Behind TED's 18-Minute Rule (online);} \urle{http://www.linkedin.com/today/post/article/20140313205730-5711504-the-science-behind-ted-s-18-minute-rule} (2014-07-21).
\bibitem{tedxrules} TED: \textit{TEDx rules (online);} \urle{http://www.ted.com/participate/organize-a-local-tedx-event/before-you-start/tedx-rules} (2014-07-21).
...
\bibitem{wwwweb} Richard Saul Wurman: \textit{WWW conference (online);} \urle{http://www.thewwwconference.com/pages/www.html} (2014-07-21).
