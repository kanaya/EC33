...
翌年にパトリック・ニューウェル (Patrick Newel) と
トッド・ポーター (Tod Porter) が米国外初となる\TEDxTokyo を開催している．\cite{tedxusc}
...
\bibitem{tedxusc} Thu-Huong Ha: \textsl{The story of the first TEDx: Q\&A with Krisztina ``Z'' Holly\online;} TED blog,
\urle{http://blog.ted.com/2012/04/17/the-story-of-the-first-tedx-qa-with-krisztina-z-holly/} (2014-08-26).
